...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibG9uZzhldmx0biIsImEiOiJjbDZ4M3ZkN3gwYzdzM2JxbXRjejVncHF0In0.7T2rFmuCjJmmH2XTsGHjWw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/long8evltn/cl6x69mpz00mr14pdlka2uxxb',
    // style URL
    scrollZoom: false // projection: 'globe', // display the map as a 3D globe
...
exports.updateSettings = exports.handleDisplayUserPhoto = void 0;
...
var handleDisplayUserPhoto = function handleDisplayUserPhoto(e) {
  ...
  var navBarImg = document.querySelector('.nav__user-img');
...
exports.handleDisplayUserPhoto = handleDisplayUserPhoto;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_51LZzbbB78umF55MTnL7mF8qMXzlfGaSHfbE9v4pFWNWMnmoAbIHJvROEIlB5qq29reOLYhSQ9LqsQQvX8Rq5Mt3t007xUrjcyY');
            _context.next = 4;
...
if (userDataForm) {
  ...
  userImgInputEl.addEventListener('change', _updateSettings.handleDisplayUserPhoto); // window.setTimeout(() => {
  //   location.reload();
  // }, 1000);
}
